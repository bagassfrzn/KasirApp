    ...
    <div class="row">
      <div class="col-lg-9 col-sm-6 mb-xl-0">
        <div class="d-flex justify-content-between align-items-center mb-3">
          ...
          <div class="add">
            @if (Auth::user()->role === 1)
              <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" style="background-color: rgb(9, 189, 92);">
                Add Product
              </button>
            @endif
          </div>
      ...
      <div class="col border-start bg-white" id="cartSection" style="min-height: 80vh;">
        ...
        <div>
          ...
          <div class="d-flex w-100">
            <button class="btn btn-danger w-100 mx-2" onclick="removeCart()">Hapus Cart</button>
            <button class="btn btn-success w-100 mx-2" onclick="checkOut()" style="background-color: rgb(9, 189, 92);">Beli</button>
          </div>
        </div>
      </div>
    </div>
        ...
        child.innerHTML = `
          <div class="card mb-2" style="max-width: 540px;">
            <div class="row g-0 align-items-center">
              ...
              <div class="col-md-3">
                ${productData && productData.images.length > 0 ?  '<img src="{{ asset("product_image/$item->file") }}" class="d-block w-100" alt="">' : '<img src="{{ asset("product_image/$item->file") }}" class="d-block w-100" alt="">'}
              </div>
              <div class="col-md-9">
                <div class="card-body">
